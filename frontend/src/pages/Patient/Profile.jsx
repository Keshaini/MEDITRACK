        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="date" value={editing ? formData.dateOfBirth : profile.dateOfBirth} onChange={(e) => setFormData({...formData, dateOfBirth: e.target.value})} disabled={!editing} className="w-full px-4 py-2 border rounded-lg" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Address</label>
              <textarea value={editing ? formData.address : profile.address} onChange={(e) => setFormData({...formData, address: e.target.value})} disabled={!editing} rows="3" className="w-full px-4 py-2 border rounded-lg" />
            </div>
          </div>
        </div>
      </div>
